...
protected:
    void SetUp() override
    {
        ...
        aircraft.descents.emplace_back(
            std::make_unique<GlideDescentModel>(90, 2.8, 3.2, 21, 15));
        aircraft.descents.emplace_back(
            std::make_unique<BallisticDescentModel>(90, 2.8, 3.2, 0.6 * 0.6, 0.8));
        // aircraft.descents.emplace_back(
        //     std::make_unique<ParachuteDescentModel>(90, 2.8, 3.2, 1.2, 12.5, 2));
    }
